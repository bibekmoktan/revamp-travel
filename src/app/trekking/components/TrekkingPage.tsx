...
/**
 * Main Trekking Page Component
 * Displays a hero section with all available treks in card or list view
 * Features filtering options and view toggle functionality
 */
        ...
        {viewMode === 'card' && (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {treks.map((trek) => (
              ...
              >
                <div className="w-full max-w-[350px] mx-auto bg-white rounded-[8px] overflow-hidden shadow-lg hover:shadow-2xl transition-shadow duration-200">
