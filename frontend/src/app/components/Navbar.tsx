    ...
    return (
        <header className="fixed top-0 left-0 w-full z-50">
            ...
            <div className="bg-[#607D8B] w-full">
                <div className="max-w-[1320px] mx-auto px-6 md:px-16 h-10 flex items-center justify-center gap-5 text-white text-sm">
                    {/* Social Icons */}
            ...
            >
                ...
                <div className="hidden lg:flex items-center gap-[50px] text-[16px] font-medium text-gray-700">
                    ...
                    <Link href="/shop" className="hover:text-sky-700 transition">
                        Shop
                    </Link>
                ...
                <div className="flex items-center gap-4 text-sm font-medium">
                    <Link
                        href="/custom-package"
                        className="hidden md:flex rounded-[12px] px-6 h-[48px] items-center justify-center text-sm font-semibold bg-sky-700 text-white hover:bg-sky-800 transition"
                    >
                        Plan Your Trip
                    </Link>
